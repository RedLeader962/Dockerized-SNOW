...
#  BASE_IMG_ARG=" --build-arg BASE_IMAGE=nvcr.io/nvidia/l4t-base:${BASE_IMG_VERSION}"
  BASE_IMG_ARG=" --build-arg BASE_IMAGE=norlabsnow/norlab-mppi-noetic-pytorch:arm64-l4t-${BASE_IMG_VERSION}"
...
#  BASE_IMG_ARG=" --build-arg BASE_IMAGE=nvcr.io/nvidia/cudagl:11.4.0-devel-${BASE_IMG_VERSION}"
  BASE_IMG_ARG=" --build-arg BASE_IMAGE=norlabsnow/norlab-mppi-noetic-pytorch:x86-${BASE_IMG_VERSION}"
